...
export class Otp implements OnInit, OnDestroy { @ViewChildren('otpInput') otpInputs!: QueryList<ElementRef>;

 otpForm!: FormGroup; otpLength: number = 6; errorMessage: string | null = null;
